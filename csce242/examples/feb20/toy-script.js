let toys = ["drums", "ball", "rope", "balloon", "tire"];
let toyPrices = [];
...
const showToysTable = () => {
    ...
    for(let toy in toyPrices) {
        ...
        tr.onclick = () => {
            ...
            descP.innerHTML = `You clicked on ${toy} and it costs $${toyPrices[toy]}.`;
        };
...
//For any function if you want to tie the function to an onclick then you cant have () after the function name when calling
// tr.onclick = showPrice(toy) --- wont work
//tr.onclick = showPrice.bind(null, toy) --- will work